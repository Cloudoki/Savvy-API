...
class BaseModel extends Model
{
	...
	public function schema ($display)
	{
		...
		if (!$display || !$rules)
		{
			throw new \Cloudoki\InvalidArgumentException ('Scheme mismatch or display parameter missing');
		}
	...
	public function schemaUpdate ($input)
	{
		...
		{
			throw new \Cloudoki\InvalidArgumentException ('Update file not found or malformed');
		}
	...
	protected static function getScheme ($filename)
	{
		...
		if (!file_exists ($file))
			...
			throw new \Cloudoki\InvalidArgumentException ('Scheme file not found');
